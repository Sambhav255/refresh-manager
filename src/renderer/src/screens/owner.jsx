    ...
    <div className="content fade-in">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 290px", gap: 16 }}>
        <div>
          ...
          <div className="tbl-foot"><span>{transactions.length} transactions · today</span><span className="total">Total: {fmt(total)}</span></div>
        </div>
...
export function OwnerTransactions() {
  ...
  return (
    <div className="content fade-in">
      ...
      <div className="tbl-foot"><span>{tx.length} transactions</span><span className="total">Total: {fmt(total)}</span></div>
    </div>
  );
}
