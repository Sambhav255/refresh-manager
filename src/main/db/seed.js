...
const poolItems = [
  { name: 'Ladies Costume', category: 'Swimwear', variant: 'Full Body', current_stock: 0, reorder_level: 3, selling_price: 0 },
  { name: 'Ladies Costume', category: 'Swimwear', variant: 'Half', current_stock: 0, reorder_level: 3, selling_price: 0 },
  { name: 'Gents Costume', category: 'Swimwear', variant: null, current_stock: 0, reorder_level: 3, selling_price: 0 },
  { name: 'Baby Costume', category: 'Swimwear', variant: 'Girls', current_stock: 0, reorder_level: 3, selling_price: 0 },
  { name: 'Baby Costume', category: 'Swimwear', variant: 'Boys', current_stock: 0, reorder_level: 3, selling_price: 0 },
  { name: 'Goggles', category: 'Accessories', variant: 'Adult Large', current_stock: 0, reorder_level: 5, selling_price: 0 },
  { name: 'Goggles', category: 'Accessories', variant: 'Adult Small', current_stock: 0, reorder_level: 5, selling_price: 0 },
  { name: 'Goggles', category: 'Accessories', variant: 'Baby', current_stock: 0, reorder_level: 5, selling_price: 0 },
  { name: 'Swimming Cap', category: 'Accessories', variant: 'Large', current_stock: 0, reorder_level: 5, selling_price: 0 },
  { name: 'Swimming Cap', category: 'Accessories', variant: 'Small', current_stock: 0, reorder_level: 5, selling_price: 0 },
  { name: 'Nose Pin', category: 'Accessories', variant: null, current_stock: 0, reorder_level: 10, selling_price: 0 },
  { name: 'Floating Tube', category: 'Equipment', variant: null, current_stock: 0, reorder_level: 2, selling_price: 0 }
]

const restaurantItems = [
  { name: 'Tea', category: 'Beverages', unit: 'cups', current_stock: 0, reorder_level: 10, selling_price: 0 },
  { name: 'Coffee', category: 'Beverages', unit: 'cups', current_stock: 0, reorder_level: 10, selling_price: 0 },
  { name: 'Water', category: 'Beverages', unit: 'bottles', current_stock: 0, reorder_level: 20, selling_price: 0 },
  { name: 'Momo', category: 'Snacks', unit: 'plates', current_stock: 0, reorder_level: 5, selling_price: 0 },
  { name: 'Samosa', category: 'Snacks', unit: 'pcs', current_stock: 0, reorder_level: 10, selling_price: 0 }
]
